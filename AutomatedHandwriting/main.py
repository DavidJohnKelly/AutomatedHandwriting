...
originalpicture = Image.open("C:/Users/wwwku/source/repos/AutomatedHandwriting/Alphabet.png")
...
smooth.close()
sharpen.save("C:/Users/wwwku/source/repos/AutomatedHandwriting/AlphabetAlpha.png")
sharpen.close()
...
Eg A B C D  becomes  A B C D  as two separate files
   E F G H
                     E F G H
'''
rgba_Alphabet = Image.open("C:/Users/wwwku/source/repos/AutomatedHandwriting/AlphabetAlpha.png")
...
for y in range(len(ycroplist) - 1):
    if not (ycroplist[y] + 1 == ycroplist[y + 1]):
        ...
        cropped.save("C:/Users/wwwku/source/repos/AutomatedHandwriting/VerticalCrop{}.png".format(verticalcounter))
        cropped.close()
        verticalcounter = verticalcounter + 1
rgba_Alphabet.close()

Files = os.listdir("C:/Users/wwwku/source/repos/AutomatedHandwriting")
...
for item in Files:
    ...
    if "VerticalCrop" in item:
        ...
        rgba_Alphabet = Image.open("C:/Users/wwwku/source/repos/AutomatedHandwriting/" + item)
        ...
        for x in range(len(xcroplist) - 1):
            if not (xcroplist[x] + 1 == xcroplist[x + 1]):
                ...
                cropped.save("HorizontalCrop{}.png".format(horizontalcounter))
                cropped.close()
...
for item in Files:
    ...
    if "HorizontalCrop" in item:
        ...
        rgba_Character = Image.open("C:/Users/wwwku/source/repos/AutomatedHandwriting/" + item)
        Character = pytesseract.image_to_string(rgba_Character.convert("RGB"), lang="eng")
        print(Character)
        ...
        cropped.save(
            "C:/Users/wwwku/source/repos/AutomatedHandwriting/{}.png".format(Character))
        # Deletes the redundant files
        os.remove("C:/Users/wwwku/source/repos/AutomatedHandwriting/" + item)
